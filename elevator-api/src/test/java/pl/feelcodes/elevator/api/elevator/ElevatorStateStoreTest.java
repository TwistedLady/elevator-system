...
class ElevatorStateStoreTest {
    ...
    void streamsEachStateChangeAndKeepsTheLatest() {
        ...
        ElevatorStateDto moving = new ElevatorStateDto("t1", "e1", "Up", "Moving", 3);
        ElevatorStateDto stopped = new ElevatorStateDto("t2", "e1", "Down", "Stopped", 7);
    ...
    void ignoresNullNameOrState() {
        ElevatorStateStore store = new ElevatorStateStore();
        store.put(null, new ElevatorStateDto("t", "e1", "Up", "Moving", 1));
        store.put("e1", null);
