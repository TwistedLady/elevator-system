...
object ManagerEvents:
  sealed trait Event
  final case class OrderCreated(orderId: String,
                                floor: Int,
                                callIds: Set[String],
                                passengers: Set[String] = Set.empty,
                                anonymousCallIds: Set[String] = Set.empty) extends Event
  final case class OrderExtended(orderId: String,
                                 callIds: Set[String],
                                 passengers: Set[String] = Set.empty,
                                 anonymousCallIds: Set[String] = Set.empty) extends Event
